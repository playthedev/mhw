...
export function enrollmentConfirmationTemplate(data: EnrollmentEmailData): string {
  ...
  const content = `
    ...
    <p style="${baseStyles.small}">Have questions? Contact us at <a href="mailto:info@mhwconsultancy.in" style="color:#818cf8;">info@mhwconsultancy.in</a> or call <a href="tel:+918802660308" style="color:#818cf8;">+91 88026 60308</a>.</p>
  `
